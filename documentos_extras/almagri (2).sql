...
-- Tiempo de generación: 20-07-2022 a las 14:38:49
...
INSERT INTO `empresas` (`empr_id`, `user_id`, `empr_nombre`, `empr_ruc`, `empr_direccion`, `empr_telefono`, `empr_celular`, `empr_correo`, `empr_contacto`, `empr_estado`, `empr_ruta_img_reporte`, `created_at`, `updated_at`, `deleted_at`, `users_id`) VALUES
(9, 8, 'Abogados S.A', '10438875820', 'adeconperuventas@gmail.com', '980560812', '980560812', 'adeconperuventas@gmail.com', NULL, 'ACTI', '', '2022-03-17 18:31:13', '2022-06-16 14:55:09', NULL, 0),
(10, 9, 'FOREVER21', '20390247487', 'Av Los Precursores 593', '980560812', '5612937', 'elizabethcanaquiri@gmail.com', NULL, 'ACTI', NULL, '2022-03-17 18:42:40', '2022-03-17 18:42:40', NULL, 0),
(11, 10, 'LUVANET modi', '20390247499', 'AV LA MOLINA 6521 modi', '45874199', '960203799', 'ventasmodi@luevanet.com', 'Ronny Tirado Bazan modi', 'ACTI', '', '2022-04-22 19:38:34', '2022-06-16 20:07:36', NULL, 0),
(16, 15, 'Veronica pruen', '20122524153', 'mz g2 lote 16, H.A Daniel Alcides Carrión Sector \"C\" Los Olivos', '4543543', '5655654654', 'saavedraphp@gmail.com', NULL, 'ACTI', NULL, '2022-06-09 15:13:58', '2022-06-09 15:14:14', '2022-06-09 15:14:14', 0);
...
(1, 'ADMIN', 'web', '2022-07-07 18:31:24', '2022-07-18 20:26:42'),
(2, 'ASISTENTE', 'web', '2022-07-07 18:31:24', '2022-07-18 20:26:09'),
(3, 'CLIENTE', 'web', '2022-07-07 18:31:24', '2022-07-18 20:26:58'),
(16, 'OPERADOR', 'web', '2022-07-18 20:15:17', '2022-07-18 20:25:32');
...
(1, 'LUIS', 'saavedraphp@gmail.com', NULL, '$2y$10$MnNjH7pF.W2QLhD2NJYbTOv6QIoG4wlq3jxfXHU23/WRwMsCI1UNi', 'EH9wp9nE4tBbECRm1oFJiNGDCzc1xfjd1KxlcJnlsvB7aZb62rjWwlynb85U', 'ACTI', '2021-02-26 05:22:30', '2022-07-18 14:08:22', NULL),
(3, 'Eduardo modi', 'egrillo@almagri.com', NULL, '$2y$10$04HZ6k.XV3c3hD3/xaCpP.XAWR112Buq2KBQoWQBkjITr44YSZzzS', 'vNIx4Fzb865AnFs0ki4rHUN2866H2fNjRUIf3gUEtjHHJJZRPXL7pqB9uhOr', 'ACTI', '2021-02-26 05:22:30', '2022-07-18 14:08:20', NULL),
(8, 'Abogados S.A', 'adeconperuventas@gmail.com', NULL, '$2y$10$FoJcwBfziPsKAbQPG4dPC.ANdHHFn8ysO3br4PZQGp4esjOm.aczO', NULL, 'ACTI', '2022-03-17 18:31:13', '2022-03-17 18:31:13', NULL),
(9, 'FOREVER21', 'elizabethcanaquiri@gmail.com', NULL, '$2y$10$LOZmpgbXswvvd6K0ga3tTepin40tsqdRx9TMuMenCnYhhWJAjoRr2', NULL, 'ACTI', '2022-03-17 18:42:40', '2022-03-17 18:42:40', NULL),
(10, 'LUVANET', 'ventas@luevanet.com', NULL, '$2y$10$b2YmFSppkFmBFBmC0pSfruLRbUaQj0MSmJhPH7O7RGl41U.aH.XEG', NULL, 'ACTI', '2022-04-22 19:38:33', '2022-04-22 19:38:33', NULL),
(15, 'Veronica pruen', 'saavedraphp@gmail.com', NULL, '$2y$10$trBT1aPpxrj/SQhim3ZByupRtCf3BS/6lRFtE/SMoazNlXt.Jntci', NULL, 'ACTI', '2022-06-09 15:13:58', '2022-07-13 14:30:20', '2022-07-13 14:30:20'),
(24, 'JESUS modi', 'saavedraphp2@gmail.com', NULL, '$2y$10$mT4gRzP3/6rKJ1prdY/ez.EenwCQThKa7ujb9JAFO2RZpeXTbuiz.', NULL, 'ACTI', '2022-07-06 21:38:05', '2022-07-13 14:30:16', '2022-07-13 14:30:16');
...
--
-- Filtros para la tabla `contactos_x_empresa`
--
ALTER TABLE `contactos_x_empresa`
  ADD CONSTRAINT `fk_empresa_id` FOREIGN KEY (`empresa_id`) REFERENCES `empresas` (`empr_id`) ON DELETE CASCADE ON UPDATE NO ACTION;
